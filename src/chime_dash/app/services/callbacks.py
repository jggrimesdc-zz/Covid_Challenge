...
from covid_challenge.model.sir import Sir
from covid_challenge.model.parameters import Parameters, Disposition
...
class IndexCallbacks(ComponentCallbacks):
    ...
    def __init__(self, component_instance):
        def handle_model_change_helper(
            ...
            return IndexCallbacks.handle_model_change(component_instance, sidebar_data, lock_zoom_clicks,
